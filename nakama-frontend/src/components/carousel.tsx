// NOTE: This is an unused prototype carousel built with framer-motion.
// The live carousel on the home page uses Embla (see airingToday/airingToday.tsx).
// This file is kept for reference but is not imported anywhere.
// If you want to replace the Embla carousel with this one, wire it up to real
// AnimeData props instead of the hardcoded placeholder cards below.
